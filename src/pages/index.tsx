...
function HomePage() {
  return (
    <>
      <Head>
        <title>TableReserve v19</title>

        <meta
          name="description"
          content="Discover TableReserve v19: Revolutionizing the dining experience with seamless table bookings, personalized customer management, and optimized occupancy for ultimate restaurant efficiency."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Discover TableReserve v19: Revolutionizing the dining experience with seamless table bookings, personalized customer management, and optimized occupancy for ultimate restaurant efficiency.`}
            </Text>
